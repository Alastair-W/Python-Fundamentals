...
# Running it with no options results in a simple output but running this file with the -v flag will give 
# you the verbose output with information on each test that was run:
